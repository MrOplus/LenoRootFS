...
echo 'AT+QCFG="nwscanmode",1,1' > /dev/ttyUSB3
...
echo "Current Cellular Mode:<br><select id=\"checknetpre\" class=\"twog\" name=\"cell\"><option value=\"auto\" >Automatic</option><option value=\"4g\" >4G Only</option><option value=\"3g\">3G Only</option><option value=\"2g\" selected>2G Only</option></select><br><br>"
