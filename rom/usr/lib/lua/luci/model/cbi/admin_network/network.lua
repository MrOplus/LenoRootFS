...
local tpl_networks = tpl.Template(nil, [[
    ...
    function hidden() {
	 ...
	 document.getElementById("wan1-ifc-description").parentElement.style.display="none" ;
	 document.getElementById("lan-ifc-description").parentElement.style.display="none" ;
     document.getElementById("wan-ifc-description").parentElement.style.display="none" ;
     document.getElementById("wan6-ifc-description").parentElement.style.display="none" ;
	 document.getElementById("wan1_4-ifc-description").parentElement.style.display="none" ;
	...
	<div class="cbi-section-node">
		<div class="table">
			...
			%>
				<div class="tr cbi-rowstylllle-<%=i+1%>">
					...
					<div class="td cbi-section-actions">
						<div>
							...
							<input style="display:none" type="submit" name="cbi.apply" class="cbi-button cbi-button-negative" onclick="iface_delete(event)" value="<%:Delete%>"<%=ifattr(dynamic, "disabled", "disabled")%> />
						</div>
					</div>
				</div>
			<% end %>
	...
	<div style="display:none"  class="cbi-section-create">
