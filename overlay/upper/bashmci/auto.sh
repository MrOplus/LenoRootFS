...
echo "Current Cellular Mode:<br><select class=\"auto\" id=\"checknetpre\"  name=\"cell\"><option value=\"auto\" selected >Automatic</option><option value=\"4g\"  >4G Only</option><option value=\"3g\" >3G Only</option><option value=\"2g\" >2G Only</option></select><br><br>"
